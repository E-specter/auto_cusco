...
| Ejecución de la ingesta | **En segundo plano** (decidido 2026-09-11) — el endpoint recibe el archivo y responde de inmediato; el frontend consulta el avance y el resultado | Caso de uso de guardado implementado (`core/services/ingesta_sabana/servicio.py`, repositorio con `COPY`); falta el ejecutor en segundo plano y los endpoints |
